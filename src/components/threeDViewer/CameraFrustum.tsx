...
interface CameraFrustumProps {
  ...
  const CameraFrustum: React.FC<CameraFrustumProps> = ({
    ...
    const instance = useMemo(() => {
      ...
      const forward = Cartesian3.clone(direction, new Cartesian3());
      ...
      // Define a perspective frustum with 16:9 aspect ratio
    ...
    }, [position, direction, fov, near, far, color]);
